...
public class YearFormatterTest {
  private YearFormatter formatter;

  @Before
  public void setUp() {
    formatter = new YearFormatter() {
      @Override
  ...
  public void testDefaultFormat() throws Exception {
    ...
    formatter.init();
    Year input = Year.of(2017);
    assertEquals(
        DateTimeFormatter.ofPattern(YearFormatter.DEFAULT_FORMAT_PATTERN).withLocale(Locale.US).format(input),
