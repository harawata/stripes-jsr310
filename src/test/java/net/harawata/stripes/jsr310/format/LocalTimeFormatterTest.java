...
public class LocalTimeFormatterTest {
  ...
  @Before
  public void setUp() {
    formatter = new LocalTimeFormatter() {
      @Override
  ...
  public void testDefaultFormat() throws Exception {
    ...
    formatter.init();
    LocalTime input = LocalTime.of(14, 34, 29);
    assertEquals(DateTimeFormatter.ofLocalizedTime(FormatStyle.SHORT).withLocale(Locale.US)
  ...
  @Test
  public void shouldLongStyleFail() throws Exception {
    Assertions.assertThatThrownBy(() -> {
      formatter.setLocale(Locale.US);
