...
public class YearMonthFormatterTest {
  private YearMonthFormatter formatter;

  @Before
  public void setUp() {
    formatter = new YearMonthFormatter() {
      @Override
  ...
  public void testDefaultFormat() throws Exception {
    ...
    formatter.init();
    YearMonth input = YearMonth.of(2017, 3);
    assertEquals(
        DateTimeFormatter.ofPattern(YearMonthFormatter.DEFAULT_FORMAT_PATTERN).withLocale(Locale.US).format(input),
